...
## Español
Ingeniero en tecnologías de la información dedicado, amante de la tecnología y el desarrollo web. Poseo conocimientos comprobables en programación orientada a objetos y desarrollo web front-end y back-end con tecnologías web como **HTML5**, **Laravel**, **React** y **Express**.
...
## English
I am an **IT engineer** dedicated to technology and web development. I have demonstrable knowledge in **object-oriented programming** and experience in both **front-end** and **back-end** web development using technologies such as **HTML5**, **Laravel**, **React**, and **Express.js**.
...
- **Try It Out**: [Universidad Monte Albán](https://umontealban.edu.mx)
